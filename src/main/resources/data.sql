...
SELECT 'admin@cursorheat.com', '$2a$10$7QJ8Qw8Qw8Qw8Qw8Qw8QwOQw8Qw8Qw8Qw8Qw8Qw8Qw8Qw8Qw8', 'Admin', 'User', 'ADMIN', TRUE, TRUE
WHERE NOT EXISTS (SELECT 1 FROM users WHERE email = 'admin@cursorheat.com');

-- Insert test user (password: password) if not exists
INSERT INTO users (email, password, first_name, last_name, role, enabled, email_verified)
SELECT 'test@example.com', '$2a$10$7QJ8Qw8Qw8Qw8Qw8Qw8QwOQw8Qw8Qw8Qw8Qw8Qw8Qw8Qw8Qw8', 'Test', 'User', 'USER', TRUE, FALSE
